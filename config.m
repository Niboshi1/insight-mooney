function cfg = config()
    ...
    % ---- Mooney images path ----
    cfg.stimDir = 'stimulus_set/soft_norm'; % directory of Mooney images relative to current directory

    % ---- Results path ----
    cfg.resultsDir = 'results'; % directory to save results relative to current directory

    % ---- Audio input channel ----
    cfg.audioChannel = 14; % audio input channel for vocal response recording
